...
export default function AdminCollections() {
  ...
  if (adminLoading || collectionsLoading) {
    return (
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-display uppercase italic text-foreground">
                Gestión de <span className="text-price-yellow">Colecciones</span>
              </h1>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      {!isEditing && (
                        <div className="flex items-center gap-2">
                          ...
                          <Button size="sm" variant="ghost" onClick={() => startEditing(collection)}>
